...
APP.ShaderDemo1 = function() {
	...
	this.init = function() {
		...
		APP.shaderMat = new THREE.ShaderMaterial( THREE.ShaderDemo1Shader );

		APP.shaderPlane = new THREE.Mesh(new THREE.PlaneGeometry(APP.stageSize, APP.stageSize), APP.shaderMat);
		APP.shaderPlane.rotation.x = 0 * Math.PI / 180;
...
window.onload = function() {
	...
	APP.stage.play = new APP.ShaderDemo1();
	APP.stage.init();
